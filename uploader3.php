  ...
  <body class="bg-primary h-100">
    <div id="wrap" class="bg-full pt-0">
      <?php include('templates/navigation-transparent2.php'); ?>
        ...
        <!-- Page Content -->
        <div id="main" class="container pt-0 pb-4 px-5">

          <!-- row -->
            <div class="row flex">

            <!-- Post Content Column -->
              <div id="upload-widget" class="col-lg-4 col-md-6 col-sm-12 bg-white px-4 py-0 mb-2 shadow-medium">
                <div class="my-1 py-2">
                  ...
                  <div class="row pb-0">
                    <div class="col-12  p-0">
                      ...
                      -->
                      <button class="font-weight-bold btn btn-block btn-light text-secondary py-3 my-0 font-weight-bold btn-sm">
                        <span class="h5">
                      ...
                      <div style="height: 100%;">
                        <ul id="list-files" class="list-group">
                          ...
                          <li class="list-group-item border-bottom">
                            <div class="row">
                              <div class="col-1 p-0"><input type="checkbox" class="form-control" disabled/></div>
                              <div class="col-8">
                          ...
                          <li class="list-group-item border-bottom text-truncate">
                            <div class="row">
                              <div class="col-1 p-0"><input type="checkbox" class="form-control" /></div>
                              <div class="col-8">
                                <div class="filename text-truncate"> Sitting for Dummies.pdf</div>
                                <div class="details">
                                  <?php
                          ...
                          <li class="list-group-item text-truncate">
                            <div class="row">
                              <div class="col-1 p-0"><input type="checkbox" class="form-control" /></div>
                              <div class="col-8">
                                <div class="filename text-truncate"> My first Zerocopy document.pdf</div>
                                <div class="details">
                                  <?php
                                  $date = new DateTime('2018-04-11 9:01');
                                  echo $date->format('jS F Y, H:i');
                  ...
                  <div class="row p-0">
                    <div class="col-6 text-right pl-0 pr-1">
                        <a class="btn btn-block text-white btn-cyan py-2 px-3 font-weight-bold text-truncate" href="printed.php" data-toggle="tooltip" data-placement="top" title="Try our home delivery service or go to your nearest Zerocopy printing location to get your documents for free if you are in a rush"><i class="fas fa-home text-light"></i> Home delivery</a>
                    </div>
                    <div class="col-6 text-right pr-0 pl-1">
                        <a class="btn btn-block text-white btn-cyan py-2 px-3 font-weight-bold text-truncate" href="map.php" data-toggle="tooltip" data-placement="top" title="Try our home delivery service or go to your nearest Zerocopy printing location to get your documents for free if you are in a rush"><i class="fas fa-map text-light"></i> Where to print</a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-5 col-md-6 col-sm-12 flex-column">
              ...
              <div class="col-lg-3 col-md-12 col-sm-12 flex-column">
